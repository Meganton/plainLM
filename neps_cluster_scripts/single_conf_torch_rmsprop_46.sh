...
#SBATCH --job-name=single_torch_conf_rmsprop_46
#SBATCH --error=neps_runs/_log/46/single_torch_conf_rmsprop/%x/%A.err
#SBATCH --output=neps_runs/_log/46/single_torch_conf_rmsprop/%x/%A.out
...
mkdir -p neps_runs/_log/46/single_torch_conf_rmsprop_46/${SLURM_JOB_NAME}

# Activate environment
source ./.venv/bin/activate

model_size="46M"
runname="46_single_conf_torch_rmsprop"
neps_space_config="AdamExtend_f_l_nw"
config="torch_RMSprop"
nproc_per_node=4
