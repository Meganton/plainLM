...
#SBATCH --job-name=li1_03_lr_sweep
...
runname="li1_03_lr_sweep"    # used as results_dir/neps/runname/... for neps files and as results_dir/results/runname_seed.json for the results file
runtime=2200                                  # ca the runtime in minutes + some overhead
