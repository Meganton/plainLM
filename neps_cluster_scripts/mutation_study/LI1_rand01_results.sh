...
#SBATCH --job-name=li1_rand_01_results
#SBATCH --output=neps_runs/_log/result_extraction/li1_rand_01_results/%a.out
#SBATCH --error=neps_runs/_log/result_extraction/li1_rand_01_results/%a.err
...
mkdir -p neps_runs/_log/result_extraction/li1_rand_01_results
...
# Job parameters
neps_optimizer="LI1_rand0.1"                   # the NEPS algorithm to use
model_size="46M"
