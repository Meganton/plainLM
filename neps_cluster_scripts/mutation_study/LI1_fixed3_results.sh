...
#SBATCH --job-name=li1_fixed_3_results
#SBATCH --output=neps_runs/_log/result_extraction/li1_fixed_3_results/%a.out
#SBATCH --error=neps_runs/_log/result_extraction/li1_fixed_3_results/%a.err
...
mkdir -p neps_runs/_log/result_extraction/li1_fixed_3_results
...
# Job parameters
neps_optimizer="LI1_fixed3"                   # the NEPS algorithm to use
model_size="46M"
