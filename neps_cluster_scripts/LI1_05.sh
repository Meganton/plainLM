...
neps_optimizer="LI1_r0.5"                   # the NEPS algorithm to use
model_size="46M"
result_dir="neps_runs/46_LI_space"
runname="li1_05"    # used as results_dir/neps/runname/... for neps files and as results_dir/results/runname_seed.json for the results file
