...
runname="short_8"    # used as results_dir/neps/runname/... for neps files and as results_dir/results/runname_seed.json for the results file
runtime=25                                  # runtime in minutes (SLURM 15 min - 2 min overhead = 13 min available)
