...
#SBATCH --job-name=single_torch_conf_sgd_nesterov
#SBATCH --error=neps_runs/_log/8/single_torch_conf_sgd_nesterov/%x/%A.err
#SBATCH --output=neps_runs/_log/8/single_torch_conf_sgd_nesterov/%x/%A.out
...
mkdir -p neps_runs/_log/8/single_torch_conf_sgd_nesterov/${SLURM_JOB_NAME}

# Activate environment
source ./.venv/bin/activate

model_size="8M"
runname="8_single_conf_torch_sgd_nesterov"
neps_space_config="AdamExtend_f_l_nw"
config="torch_SGD_Nesterov"
nproc_per_node=4
