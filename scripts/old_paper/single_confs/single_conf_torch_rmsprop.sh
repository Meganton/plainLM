...
#SBATCH --job-name=single_torch_conf_rmsprop
#SBATCH --error=neps_runs/_log/8/single_torch_conf_rmsprop/%x/%A.err
#SBATCH --output=neps_runs/_log/8/single_torch_conf_rmsprop/%x/%A.out
...
mkdir -p neps_runs/_log/8/single_torch_conf_rmsprop/${SLURM_JOB_NAME}

# Activate environment
source ./.venv/bin/activate

model_size="8M"
runname="8_single_conf_torch_rmsprop"
