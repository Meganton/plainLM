...
styles = {}
styles["RealAdamExtend_PB_like"] = {"color": colors[0], "linestyle": "-", "label": "'Adam-Extend-Add'-Space"}
styles["AdamExtendMul_PB_like"] = {"color": colors[1], "linestyle": "-", "label": "'Adam-Extend-Mul'-Space"}
# styles["Real2PremadeModules_PB_like"] = {"color": colors[2], "linestyle": "-", "label": "'Premade-Modules'-Space"}
# styles["NLinesU_PB_like"] = {"color": colors[4], "linestyle": "-", "label": "'10 Lines + Update'-Space"}
# styles["Adam"] = {"color": colors[5], "linestyle": "--", "label": "Adam (Niccolo)"}
# styles["AE_Adam_torch"] = {"color": colors[6], "linestyle": "--", "label": "Adam (Torch)"}
styles["AE_Adam_base"] = {"color": colors[7], "linestyle": "--", "label": "Adam (tuned LR)"}
# styles["Muon"] = {"color": colors[6], "linestyle": "--", "label": "Muon (tuned LR)"}
x_axis = "Evaluations"
...
fig, ax = plot_results(
    ...
    max_fidelity=15,
    style_dict={
        "title": "NEPS NOS - Space ablation - 8M Parameters",
...
# fig.suptitle("NEPS NOS - Space ablation - 8M Parameters", y=1.02)
# Save the figure
fig.savefig(
    "neps_plots/plots/space_ablation.png", bbox_inches="tight", pad_inches=0.1, dpi=300
)