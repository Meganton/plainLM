...
styles = {}
styles["NLinesU_LI3_r03"] = {"color": colors[1], "linestyle": "-", "label": "HB w/ Local Prior/Incumbent (ws SGDM inter)"}
styles["NLinesU_LI3_r03_ws_add"] = {"color": colors[6], "linestyle": "-", "label": "HB w/ Local Prior/Incumbent (ws SGDM add)"}
...
fig.suptitle("NEPS NOS - LI warmstarter ablation - 8M Parameters", y=1.02)
# Save the figure
fig.savefig(
    "neps_plots/plots/li_w_ablation.png", bbox_inches="tight", pad_inches=0.1, dpi=300
)