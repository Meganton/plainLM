...
titles = ["Fixed ratio of samplings",
 "Random ratio of samplings",
 "Fixed number of samplings"]
...
for n,group in enumerate([ratios, randoms, fixeds]):
    ...
    figs[n].suptitle(titles[n], y=1.02)
    # Save the figure
    figs[n].savefig(
        f"neps_plots/plots/extension/li_ablation_{n}.png", bbox_inches="tight", pad_inches=0.1, dpi=300
    )