...
styles = {}
styles["RealAdamExtend_PB_like"] = {"color": colors[1], "linestyle": "-", "label": r"Ours (\texttt{Adam} Addition)"}
...
# Save the figure
fig.savefig(
    "neps_plots/plots/extension/8_sota_comparison.png", bbox_inches="tight", pad_inches=0.1, dpi=300
)
...
# Save the figure
fig.savefig(
    "neps_plots/plots/extension/8_sota_comparison_ranks.png", bbox_inches="tight", pad_inches=0.1, dpi=300
)