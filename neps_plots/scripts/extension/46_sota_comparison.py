...
# styles["46_single_conf_torch_adagrad"] = {"color": colors[9], "linestyle": "--", "label": r"\texttt{Adagrad (tuned $\gamma$)}"}
# styles["46_single_conf_torch_sgd"] = {"color": colors[4], "linestyle": "--", "label": r"\texttt{SGD (tuned $\gamma$)}"}
styles["46_single_conf_torch_rmsprop"] = {"color": colors[6], "linestyle": "--", "label": r"\texttt{RMSprop (tuned $\gamma$)}"}
# styles["46_single_conf_torch_sgd_momentum"] = {"color": colors[5], "linestyle": "--", "label": r"\texttt{SGD w/ Momentum} (tuned $\gamma$)"}
...
# styles["Anton_Adam_torch"] = {"color": colors[3], "linestyle": "--", "label": r"\texttt{Adam} (tuned $\gamma$)"}

only_best = ["Anton_Adam_AE", "46_single_conf_torch_sgd", "46_single_conf_torch_adagrad", "46_single_conf_torch_sgd", "46_single_conf_torch_nadam", "46_single_conf_torch_rmsprop", "46_single_conf_torch_sgd_momentum"]#, "46_single_conf_adam_wd"]
...
fig.suptitle(r"\texttt{Adam} Extension-Optimizers on 46M Parameter Model", y=1.02)
# Save the figure
fig.savefig(
    "neps_plots/plots/extension/46_sota_comparison.png", bbox_inches="tight", pad_inches=0.1, dpi=300
)
...
# Save the figure
fig.savefig(
    "neps_plots/plots/extension/46_sota_comparison_ranks.png", bbox_inches="tight", pad_inches=0.1, dpi=300
)
